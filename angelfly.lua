...
local title = mkLabel(topBar, "angel fly v1", 22, true)
title.Position = UDim2.fromOffset(18, 10)
title.Size = UDim2.new(1, -120, 0, 24)

local tag = mkLabel(topBar, "antiban | vzzox UI", 12, false)
...
local discordBtn = mkButton(content, "JOIN DISCORD")
...
local hint = mkLabel(content, "made by vzzox hub", 11, false)
